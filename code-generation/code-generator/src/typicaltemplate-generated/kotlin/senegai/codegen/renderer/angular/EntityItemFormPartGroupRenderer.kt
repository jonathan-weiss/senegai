    ...
    override fun renderTemplate(model: UiEntityFormViewItemModel): String {
        return """
          ...
          |    ${ model.item.attributes.joinToString("") { attribute ->  """
              |    [${model.item.itemName.pascalCase}FormPartFieldName.${attribute.attributeName.camelCase}]: ${attribute.angularFormControlTypeWithCollection},${ if(attribute.isNullable) { """
