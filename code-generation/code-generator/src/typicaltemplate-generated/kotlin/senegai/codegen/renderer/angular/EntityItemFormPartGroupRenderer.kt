 ...
 * - file: `author-form-part-group.ts`
 * - path: `opus-magnum/opus-magnum-form/author-form-part/author-form-part-group.ts`
 */
    ...
    override fun renderTemplate(model: UiEntityFormViewItemModel): String {
        return """
          ...
          |export interface ${model.item.itemName.pascalCase}FormPartGroup {${ model.item.attributes.joinToString("") { attribute ->  """
              |    [${model.item.itemName.pascalCase}FormPartFieldName.${attribute.attributeName.camelCase}]: FormControl<${attribute.typescriptAttributeFormType}>,${ if(attribute.isNullable) { """
