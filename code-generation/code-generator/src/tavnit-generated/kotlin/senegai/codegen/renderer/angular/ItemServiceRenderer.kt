...
object ItemServiceRenderer : UiItemRenderer {
    ...
    override fun renderTemplate(model: UiItemModel): String {
        return """
          ...
          |    }
          |
          |    get${model.itemName.pascalCase}ById(${model.primaryKeyAttribute.attributeName.camelCase}: UUID): Observable<${model.itemName.pascalCase}WTO | null> {
          |        return this.http.get<${model.itemName.pascalCase}WTO | null>(`${"$"}{this.baseUrl}/${"$"}{${model.primaryKeyAttribute.attributeName.camelCase}}`);
          |    }
          |
          |    delete${model.itemName.pascalCase}(${model.primaryKeyAttribute.attributeName.camelCase}: UUID): Observable<void> {
